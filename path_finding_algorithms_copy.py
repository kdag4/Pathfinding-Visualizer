...
def make_buttons():#buttons
    ...
    button_list.extend([start_button,end_button,wall_button,weight_button,dijkstra_button,A_Star_button,best_first_button,depth_first_button,breadth_first_button])
    button_list.extend([clear_button,run_all_button,kruskal_button,prim_jarnik_button,tutorial_button,analytics_button])

def make_sliders():#sliders
